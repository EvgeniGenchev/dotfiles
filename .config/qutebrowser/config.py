...
def filter_yt(info: interceptor.Request):
    ...
    if(url.host() == "www.youtube.com" and url.path() == "/gen_video_info" and "&adformat=" in url.query()):
        info.block()
...
# default is used.
# Type: Directory
c.downloads.location.directory = '~/workspace/dl'
...
# Type: QssColor
c.colors.completion.item.selected.bg = '#928374'

# Foreground color of the matched text in the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.match.fg = '#8ec07c'
...
# Type: QssColor
c.colors.downloads.bar.bg = '#282835'
...
# Type: QtColor
c.colors.hints.match.fg = '#a89984'
...
# Type: QssColor
c.colors.statusbar.insert.bg = '#8ec07c'
...
# Type: QtColor
c.colors.tabs.pinned.even.bg = '#79740e'
...
# Type: Font
c.fonts.prompts = 'default_size "Source Code Pro"'
